...
<!-- Main content -->
  <main> 
  <section class="section-background banner-graduation">
...
<!-- Product Gallery -->
<div class="page">
  <section class="section_product gallery_graduation">
    <div class="gallery">
      ...
      <div class="container G1">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"New Horizons" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G2">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Wings of Success" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G3">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Bright Future" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G4">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Dreams in Front" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G5">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Journey of Triumph" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G6">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"The Next Chapter" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G7">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Courage to Soar" added to your cart</p>
            <div class="actions">
      ...
      <div class="container G8">
        <div class="overlay">
          ...
          <div class="items confirmation">
            <p>"Starting Petals" added to your cart</p>
            <div class="actions">
